...
apps/
  lemonade/          ← THE product. Put serious work here.
    README.md
    src/app/         Expo Router screens (setup, Invent / Print / Open, parent)
    src/             brand, store, print sheets
app/stand/           ← old web prototype. Reference only. Redirected on the live site.
```
