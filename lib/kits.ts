...
export const KITS: Kit[] = [
  {
    ...
    saturday:
      "Kids invent the name, the logo, the menu, and the prices. A parent hits print. Then you go outside and open. The poster on the table is the product.",
    ...
    parent: "You own the account. You hit print. You keep it safe.",
